...
const BBS_TOKEN_OWNER = process.env.BBS_TOKEN_OWNER || '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266';
...
async function main() {
    ...
    console.log(`BBS balance of ${BBS_TOKEN_OWNER} (wei): ${await bbsToken.balanceOf(BBS_TOKEN_OWNER)}`);
}
