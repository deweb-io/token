...
describe('End to End', () => {
    ...
    it('end to end 3 [ @skipOnCoverage ]', async() => {
        await runScenario([
            ...
            {action: 'deposit', 'amount': 10**6 }, // deposit back the original stake amount before Q2 ends on SubStaking
            ...
            {action: 'claimSub', 'staker': 'binanceStaker1', stakeIdx: 0, assertClaimEquals: 127464636}, //127464636 = (10**6 + 3929273(Q2 reward) + 250000000(Q1 reward))/2
